...
AuthHelper::checkModule("teamleader");
...
href="../../controllers/TeamLeaderController.php?delete=<?= $row['id']; ?>"

class="btn btn-danger btn-sm"

onclick="return confirm('Delete Team Leader?')">
...
action="../../controllers/TeamLeaderController.php"

method="POST">

<div class="modal-header">

<h5>Edit Team Leader</h5>
